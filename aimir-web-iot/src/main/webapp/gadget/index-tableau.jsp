...
<html lang="en">
  ...
  <body class="nav-md">
    	...
    	$.getJSON('${ctx}/gadget/tableau/getTicketFromTableau.do', function(json) {
    		if(json.status == 'SUCCESS') {
    			if(json.status == 'SUCCESS') {
    				...
    				var url = json.embedGetAddress + "/views/IoT-New-Main/IoT-New-Main?:embed=y&:showAppBanner=false&:display_count=no&:showVizHome=no&:toolbar=no&:";
	...
	<!-- <script type="text/javascript">
	    ...
	    function initViz() {
	        var containerDiv = document.getElementById("vizContainer"),
	        url = "http://localhost:8000/views/IoT-New-Main/IoT-New-Main?:embed=y&:showAppBanner=false&:display_count=no&:showVizHome=no#5";
	        //http://localhost:8000/views/IoT-Main/Tableau-Main?:embed=y&:showAppBanner=false&:display_count=no&:showVizHome=no#3
