    	...
    	$.getJSON('${ctx}/gadget/tableau/getTicketFromTableau.do', function(json) {
    		if(json.status == 'SUCCESS') {
    			if(json.status == 'SUCCESS') {
    				...
    				var url = json.embedGetAddress + "/views/IoT-DistributionMapChart/Distributed-MapStory/ask/WDDistributionMapChart?:embed=y&:showAppBanner=false&:display_count=no&:showVizHome=no&:toolbar=no&:";
