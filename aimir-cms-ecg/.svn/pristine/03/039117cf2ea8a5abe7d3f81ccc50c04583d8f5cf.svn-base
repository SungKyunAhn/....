...
public class LoadDebt {

    @Test
    public void test_getDebt() throws Exception {
        ...
        if(getDebtResp.getErrorParam().getErrorId() == ErrorType.NoError.getIntValue()){
        	...
        	debtEnt2.setDebtAmount(456.34);
        	debtEnt2.setDebtStatus("ACTIVE");
        	
        	AddDebtResp resp = port.addDebt(authCred, debtEnt2);
        }
