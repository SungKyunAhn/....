 ...
 */
@Component
public class EV_200_17_0_Action implements EV_Action
{
    private static Log log = LogFactory.getLog(EV_200_17_0_Action.class);
    ...
    {
        log.debug("EV_200_17_0_Action : EventCode[" + trap.getCode()
                +"] MCU["+trap.getMcuId()+"]");
        ...
        try {
            ...
            log.debug("EV_200_17_0_Action : mcuId[" + mcuId + "]");
            ...
            if(mcu != null)
            {
                ...
                log.info("MCU Low Batter Restore Action Started");
                EventAlertLog alert = EventUtil.findOpenAlert(event);
                
                if (alert == null)
                {
                    log.warn("MCU Low Batter Restore Action failed");
            ...
            {
                log.warn("MCU Low Batter Restore Action failed : Unknown MCU");
            }
        }
        finally {
