...
/**
 * Event ID : 200.21.0 Processing Class
 *
 * @author D.J Park (dong7603@nuritelecom.com)
 * @version $Rev: 1 $, $Date: 2005-12-13 15:59:15 +0900 $,
 */
@Component
public class EV_200_21_0_Action implements EV_Action
{
    private static Log log = LogFactory.getLog(EV_200_21_0_Action.class);
    ...
    {
        log.debug("EV_200_21_0_Action : EventCode[" + trap.getCode()
                +"] MCU["+trap.getMcuId()+"]");
