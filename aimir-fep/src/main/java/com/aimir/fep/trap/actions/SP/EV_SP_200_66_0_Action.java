...
public class EV_SP_200_66_0_Action implements EV_Action {
	...
	public void execute(FMPTrap trap, EventAlertLog event) throws Exception {
		...
		try {
			...
			logger.debug("[EV_SP_200_66_0_Action] upgradeType={}", OTA_UPGRADE_TYPE.getItem(upgradeType));
	...
	public void makeEvent(TargetClass activatorType, String activatorId, TargetClass targetType, String openTime, OTA_UPGRADE_RESULT_CODE resultCode, String message, String operatorType) {
		logger.debug("[EV_SP_200_66_0_Action][evtOTADownloadResult] MakeEvent.");
		...
		try {
			...
			logger.debug("[EV_SP_200_66_0_Action][openTime={}] evtOTADownloadResult - {}", openTime, resultValue);
		} catch (Exception e) {
