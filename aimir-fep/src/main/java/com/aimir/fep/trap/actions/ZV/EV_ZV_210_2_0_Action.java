...
/**
 * Event ID : ZV_210.2.0 (Discovery result)
 * <br>Zigbee Modem
 *
 * @author goodjob
 ...
 */
@Component
public class EV_ZV_210_2_0_Action implements EV_Action
{
    private static Log log = LogFactory.getLog(EV_ZV_210_2_0_Action.class);
    ...
    public void execute(FMPTrap trap, EventAlertLog event) throws Exception
    {
        ...
        log.debug("Zigbee Modem Discovery result Action Compelte");
    }
