 ...
 */
@Component
public class EV_NG_200_12_0_Action implements EV_Action {
	private static Log log = LogFactory.getLog(EV_NG_200_12_0_Action.class);
	...
	public void execute(FMPTrap trap, EventAlertLog event) throws Exception {
		...
		try {
			...
			log.debug("EventName[evtIpChange] IP Change [" + orgIp + "] ==> [" + ntwEthIp + "]");
			...
			if(mcu == null) {
             ...
             event.append(EventUtil.makeEventAlertAttr("newIp", "java.lang.String",ntwEthIp));
			 event.setSupplier(mcu.getSupplier());
			 event.setActivatorIp(ntwEthIp);
...
//			log.debug("EventName[evtIpChange] IP Change [" + orgIp + "] ==> [" + ntwEthIp + "]");
//
//			String ip = event.getEventAttrValue("ntwEthIp");
//			event.remove("ntwEthIp");
//			event.append(EventUtil.makeEventAlertAttr("ip", "java.lang.String", ntwEthIp));
//		} catch (Exception e) {
//			log.error(e, e);
//		} finally {
//			if (txstatus != null)
