...
public class A2RL_DataConstants
{
	...
	public static final byte CLASS_17       = 0x11;
	...
	public static final byte PAD_TIMEOUT = 0x08;	// 0x06 -> 0.5 sec
	//public static final byte PAD_TIMEOUT = 0x06;
	public static final byte ACK = 0x00;
	
	public static final int HEADER  = 5;	// header length.
