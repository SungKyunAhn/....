/**
 * @(#)GetBasePulse.java       1.0 2009-03-06 *
...
public class GetBasePulse extends CommandIEIU {
    private static Log log = LogFactory.getLog(GetBasePulse.class);
    
    public static final byte CMD_GET_BASEPULSE = (byte)0xC0;

    public static byte grpid = 0x00;
    public static byte memid = 0x00;
    public static byte[] date= null;

    /**
     * Contructor.<p>
     * @param type byte
     */
    public GetBasePulse(byte cmd, byte grpid, byte memid, byte[] date ) {
        super(cmd,"");
        this.grpid = grpid;
        this.memid = memid;
        this.date = date;
    ...
    public static void main(String[] argv) {
        ...
        try {
            ...
            Command c = new GetBasePulse(GetBasePulse.CMD_GET_BASEPULSE, grpid, memid, null);
