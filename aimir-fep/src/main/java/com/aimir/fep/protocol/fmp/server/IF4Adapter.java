 ...
 */
public class IF4Adapter implements IF4AdapterMBean, 
       MBeanRegistration 
{ 
	private static Log log = LogFactory.getLog(IF4Adapter.class);
    private ObjectName objectName = null;
    
    private IF4NewAdapter trapAdapter;
    ...
    public IF4Adapter() {
        trapAdapter = (IF4NewAdapter)DataUtil.getBean(IF4NewAdapter.class);
    }
