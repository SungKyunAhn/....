...
public class A1RLQ_RequestDataFrame extends RequestDataFrame{

    @SuppressWarnings("unused")
	private static Log log = LogFactory.getLog(A1RLQ_RequestDataFrame.class);
     ...
     * constructor
     */
    public A1RLQ_RequestDataFrame()
    {
    }
    
    public A1RLQ_RequestDataFrame(BYTE service, BYTE control, 
    ...
    public A1RLQ_RequestDataFrame(BYTE service, 
     ...
     */
    public static A1RLQ_RequestDataFrame decode(IoBuffer bytebuffer) 
    throws Exception
    {
    ...
    public byte[] encode() throws Exception
    {
    	...
    	int idx =0;
    	buf[idx++] = (byte) A1RLQ_DataConstants.STX;
    	...
    	buf[idx++]	=	A1RLQ_DataConstants.getCRCH(buf);
    	buf[idx]	=	A1RLQ_DataConstants.getCRCL(buf);
