...
public class KeepAliveMessageInterval extends AbstractCommand{
    private int interval;
    private Status status;

    public KeepAliveMessageInterval() {
        super(new byte[] {(byte)0x20, (byte)0x09});
    }
	...
	public String toString() {
	    return "[KeepAliveMessageInterval]"+
	    	   "[status:"+status.name()+"]";
	}
