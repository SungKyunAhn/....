 ...
 * @author Kang, Soyi
 */
public class EDMI_Mk6N_RequestDataFrame extends RequestDataFrame
{
    @SuppressWarnings("unused")
    private static Log log = LogFactory.getLog(EDMI_Mk6N_RequestDataFrame.class);
     ...
     * constructor
     */
    public EDMI_Mk6N_RequestDataFrame()
    {
    }
    
    public EDMI_Mk6N_RequestDataFrame(BYTE service, OCTET command,
     ...
     */
    public static EDMI_Mk6N_RequestDataFrame decode(IoBuffer bytebuffer) 
        throws Exception
    {
    ...
    public byte[] encode() throws Exception
    {
        ...
        if(commandValue!=null && commandValue.length>0)
        	...
        	return new byte[]{EDMI_Mk6N_DataConstants.ESC,EDMI_Mk6N_DataConstants.STX, EDMI_Mk6N_DataConstants.ETX};
        }
        ...
        if(data!=null && data.length>0){
        	...
        	buf = new byte[]{EDMI_Mk6N_DataConstants.STX, EDMI_Mk6N_DataConstants.ETX};
        	return buf;
        }
   ...
   //     log.debug("data : "+data.length);
        ...
        */
        int idx =0;
        buf[idx++]= EDMI_Mk6N_DataConstants.STX;
        crc = EDMI_Mk6N_DataConstants.CalculateCharacterCRC16(crc,buf[0]);
        ...
        */
        for (int i=0; i<commandValue.length; i++) {
	        ...
	        crc = EDMI_Mk6N_DataConstants.CalculateCharacterCRC16(crc,commandValue[i]);
        }
        for (int i=0; i<data.length; i++) {
	        ...
	        crc = EDMI_Mk6N_DataConstants.CalculateCharacterCRC16(crc,data[i]);
        }
        ...
        * Add the ETX
        */
        dataFinal[idx] = EDMI_Mk6N_DataConstants.ETX;
    ...
    */
    public byte[] send_byte(byte d)
    {
	    ...
	    switch(d) {
		    ...
		    case EDMI_Mk6N_DataConstants.XON:
		    case EDMI_Mk6N_DataConstants.XOFF:
		    	b = new byte[]{EDMI_Mk6N_DataConstants.DLE, (byte)(d|0x40)};
		    break;
		    default:
		    	b = new byte[]{d};
	    }
