...
public class EMnVNVResetAction extends EMnVActions {
	private static Logger logger = LoggerFactory.getLogger(EMnVNVResetAction.class);
	private EMnVCommandSubFrameType commandType;
	private RWSType rwsType;
	private ActionCommandType actionCommandType = ActionCommandType.NV_RESET;

	public EMnVNVResetAction(EMnVCommandSubFrameType commandType) {
