...
public class DLMSEMnVGtypeTag {
    ...
    public String toString() {
        ...
        buf.append("TAG[" + tag + "] LENGTH[" + length + "] DATA[" + Hex.decode(data) + "] "
        		//+ "VALUE[" + (value instanceof OCTET? Hex.decode(((OCTET)value).getValue()):value) + "]");
        		+ "VALUE[" + (value instanceof OCTET? ((OCTET)value).toString() : value) + "]");
        return buf.toString();
    }
}
