...
public class DLMSVARIABLE {
    ...
    public enum LP_STATUS{
    	CriticalError(401,"Critical error"),
    	ClockInvalid(402,"Clock invalid"),
    	DataNotValid(403,"Data not valid"),
    	DaylightSaving(404,"Daylight saving"),
    	NotUsed04(405,"Not used04"),
    	ClockAdjusted(406,"Clock adjusted"),    	
    	NotUsed06(407,"Not used06"),
    	PowernDown(408,"Power Down");
