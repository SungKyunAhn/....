/* 
 * @(#)DLMSKepco_MDM.java       1.0 2008-04-16 *
 * 
 * Modem Information.
 ...
 */
public class DLMSKepco_MDM implements java.io.Serializable{

	private static final long serialVersionUID = -8150572976847838274L;
    ...
    private static Log log = LogFactory.getLog(DLMSKepco_MDM.class);
	 ...
	 */
	public DLMSKepco_MDM(byte[] rawData) {
    ...
    public String toString()
    {
        ...
        try{
            sb.append("DLMSKepco_MDM Meter DATA[");        
            ...
            log.warn("DLMSKepco_MDM TO STRING ERR=>"+e.getMessage());
        }
