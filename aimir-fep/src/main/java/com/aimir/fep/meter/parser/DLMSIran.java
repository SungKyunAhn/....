...
public class DLMSIran extends MeterDataParser implements java.io.Serializable {

	private static final long serialVersionUID = 8916023997892795309L;

	private static Log log = LogFactory.getLog(DLMSIran.class);
    ...
    public void setMeterInfo() {
        try {
            ...
            if (map != null) {
	            ...
	            if (obj != null) lpInterval = (Integer)obj;
	            log.debug("INTERVAL[" + lpInterval + "]");
