...
import com.aimir.fep.meter.parser.DLMSIran;
...
@Service
public class DLMSIranMDSaver extends AbstractMDSaver {
	private static Log log = LogFactory.getLog(DLMSIranMDSaver.class);

	private String meterDate = "";
	@Override
	protected boolean save(IMeasurementData md) throws Exception {
		DLMSIran parser = (DLMSIran) md.getMeterDataParser();		
	...
	public void saveLp(IMeasurementData md, DLMSIran parser) throws Exception {
    ...
    public void saveLPData(List<Double>[] chValue, List<Integer> flag, String startlpdate, double baseValue, DLMSIran parser)
            throws Exception {
	...
	private void saveEventLog(DLMSIran parser) {
	    try {
	...
	private void saveEtypeBilling(DLMSIran parser){
	...
	private void savePreBill(DLMSIran parser) {
	    Double value = 0.0;
	...
	private void saveCurrBill(DLMSIran parser) {
        Double value = 0.0;
	...
	private void savePreBill2(DLMSIran parser) {
	    Double value = 0.0;
	...
	private void saveCurrBill2(DLMSIran parser) {
        Double value = 0.0;        
        // 빌링 정보 저장
	...
	private boolean lpSave(IMeasurementData md, LPData[] validlplist,
			DLMSIran parser, double base,double addBasePulse) throws Exception {
