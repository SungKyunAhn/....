...
/**
 * <p>Java class for cmdEntryStdSet complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="cmdEntryStdSet">
 *   &lt;complexContent>
 ...
 *         &lt;element name="PropertyValueList" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "cmdEntryStdSet", propOrder = {
    "mcuId",
    "index",
    "propertyNameList",
    "propertyValueList"
})
public class CmdEntryStdSet {
    ...
    @XmlElement(name = "PropertyValueList")
    protected List<String> propertyValueList;
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the propertyValueList property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPropertyValueList().add(newItem);
     * </pre>
     * 
     * 
     * <p>
