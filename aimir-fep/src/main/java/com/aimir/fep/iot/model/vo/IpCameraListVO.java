...
public class IpCameraListVO {
	...
	protected List<IpCarmeraItemListVO> item;
	...
	public List<IpCarmeraItemListVO> getItem() {
		return item;
	}

	public void setItem(List<IpCarmeraItemListVO> item) {
		this.item = item;
	}
