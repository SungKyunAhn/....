...
public class CuttingAreaListVO {
	...
	protected List<CuttingAreaItemListVO> item;
	...
	public List<CuttingAreaItemListVO> getItem() {
		return item;
	}

	public void setItem(List<CuttingAreaItemListVO> item) {
		this.item = item;
	}
