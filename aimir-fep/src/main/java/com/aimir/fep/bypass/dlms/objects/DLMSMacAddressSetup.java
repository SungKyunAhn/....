...
public class DLMSMacAddressSetup extends DLMSObject implements DLMSBase
{
    private String m_MacAddress;
    /**  
     Constructor.
    */
    public DLMSMacAddressSetup()
    {
    ...
    */
    public DLMSMacAddressSetup(String ln)
    {
    ...
    */
    public DLMSMacAddressSetup(String ln, int sn)
    {
    ...
    */
    ...
    public void setValue(int index, Object value)
    {
        ...
        {
            String add = DLMSClient.changeType((byte[]) value, DataType.OCTET_STRING).toString();
            add = add.replaceAll(".", ":");
            setMacAddress(add);
        }
        else
