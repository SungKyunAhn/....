...
public class DLMSClock extends DLMSObject implements DLMSBase
{
    ...
    int Deviation;
    boolean Enabled;
    DLMSDateTime End = new DLMSDateTime();
    ClockStatus Status;
    DLMSDateTime Begin = new DLMSDateTime();
    int TimeZone;
    DLMSDateTime Time = new DLMSDateTime();
    /**  
     Constructor.
    */
    public DLMSClock()
    ...
    */
    public DLMSClock(String ln, int sn)
    {
    ...
    */
    ...
    public final void setBegin(DLMSDateTime value)
    {
        Begin = value;
    }
    ...
    public final void setEnd(DLMSDateTime value)
    {
        End = value;
    }
    ...
    */
    ...
    public byte[][] invoke(Object sender, int index, Object parameters)
    {
        ...
        {           
            DLMSDateTime presetTime = (DLMSDateTime) DLMSClient.changeType((byte[]) Array.get(parameters, 0), 
                    DataType.DATETIME);
            DLMSDateTime validityIntervalStart  = (DLMSDateTime) DLMSClient.changeType((byte[]) Array.get(parameters, 1), 
                    DataType.DATETIME);
            DLMSDateTime validityIntervalEnd = (DLMSDateTime) DLMSClient.changeType((byte[]) Array.get(parameters, 2), 
                    DataType.DATETIME);
            setTime(presetTime);
        }
        // Shifts the time.
     ...
     * (*:00, *:15, *:30, *:45).
     */
    public byte[][] adjustToQuarter(DLMSClient client)
    {
     ...
     */
    public byte[][] adjustToMeasuringPeriod(DLMSClient client)
    {
     ...
     */
    public byte[][] adjustToMinute(DLMSClient client)
    {
     ...
     */
    public byte[][] adjustToPresetTime(DLMSClient client)
    {
     ...
     */
    public byte[][] presetAdjustingTime(DLMSClient client, Date presetTime, Date validityIntervalStart, Date validityIntervalEnd)
    {        
        ...
        try 
        {
            Common.setData(stream, DataType.DATETIME, presetTime);
            Common.setData(stream, DataType.DATETIME, validityIntervalStart);
            Common.setData(stream, DataType.DATETIME, validityIntervalEnd);
        } 
        catch (Exception ex) 
        {
     ...
     */
    public byte[][] shiftTime(DLMSClient client, int time)
    {
    ...
    public void setValue(int index, Object value)
    {
        ...
        else if (index == 2)
        {
            ...
            else
            {
                ...
                {
                    value = DLMSClient.changeType((byte[]) value, DataType.DATETIME);
                }                
