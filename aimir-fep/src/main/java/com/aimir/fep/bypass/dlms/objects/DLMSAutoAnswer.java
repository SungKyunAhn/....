...
public class DLMSAutoAnswer extends DLMSObject implements DLMSBase
{
    private AutoConnectMode m_Mode;
    private List<AbstractMap.SimpleEntry<DLMSDateTime, DLMSDateTime>> m_ListeningWindow;
    ...
    /**  
     Constructor.
    */
    public DLMSAutoAnswer()
    {
        super(ObjectType.AUTO_ANSWER, "0.0.2.2.0.255", 0);
        m_ListeningWindow = new ArrayList<AbstractMap.SimpleEntry<DLMSDateTime, DLMSDateTime>>();
    }
    ...
    */
    public DLMSAutoAnswer(String ln)
    {
    ...
    */
    public DLMSAutoAnswer(String ln, int sn)
    {
    ...
    public final List<AbstractMap.SimpleEntry<DLMSDateTime, DLMSDateTime>> getListeningWindow()
    {
        return m_ListeningWindow;
    }
    public final void setListeningWindow(List<AbstractMap.SimpleEntry<DLMSDateTime, DLMSDateTime>> value)
    {
    ...
    public Object getValue(int index, int selector, Object parameters)
    {
        ...
        if (index == 3)
        {
            ...
            if (cnt != 0)
            {
                try
                {                    
                    for(AbstractMap.SimpleEntry<DLMSDateTime, DLMSDateTime> it : getListeningWindow())
                    {
        ...
        if (index == 6)
        {
            ByteArrayOutputStream data = new ByteArrayOutputStream();   
            data.write(DataType.STRUCTURE.getValue());
            Common.setObjectCount(2, data);
            try
            {
                Common.setData(data, DataType.UINT8, m_NumberOfRingsInListeningWindow);
                Common.setData(data, DataType.UINT8, m_NumberOfRingsOutListeningWindow);
            }                
            catch (Exception ex) 
            {
                Logger.getLogger(DLMSClock.class.getName()).log(Level.SEVERE, null, ex);
