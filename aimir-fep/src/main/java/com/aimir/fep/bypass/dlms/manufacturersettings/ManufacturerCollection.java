...
public class ManufacturerCollection extends java.util.ArrayList<Manufacturer>
{
    ...
    */
    public final Manufacturer findByIdentification(String id)
    {
        for (Manufacturer it : this)
        {
    ...
    */
    ...
    {        
        ...
        try
        {
            ...
            URLConnection conn = gurux.openConnection();
    ...
    */
    ...
    public static void readManufacturerSettings(ManufacturerCollection Manufacturers, String path)
    {
        Manufacturers.clear();
     ...
     * @throws Exception
     */
    private static Manufacturer parse(InputStream in) throws Exception
    {
        ...
        DLMSAuthentication authentication = null;
        ServerAddress serveraddress = null;
        ObisCode obisCode = null;
        DLMSAttribute att = null;
        while(xmlStreamReader.hasNext())
        {
            int event=xmlStreamReader.next();
            if(event==XMLStreamConstants.START_ELEMENT)
            {
                ...
                data = null;
                target = xmlStreamReader.getLocalName();
                if (target.equalsIgnoreCase("Manufacturer"))
                {
                    man = new Manufacturer();
                }
                else if(target.equalsIgnoreCase("ObisCode"))
                {
                    obisCode = new ObisCode();
                    man.getObisCodes().add(obisCode);
                }
                else if(target.equalsIgnoreCase("Authentication"))
                {
                    authentication = new DLMSAuthentication();
                    man.getSettings().add(authentication);
                }
                else if(target.equalsIgnoreCase("ServerAddress"))
                {
                    serveraddress = new ServerAddress();
                    man.getServerSettings().add(serveraddress);
                }
                else if(target.equalsIgnoreCase("DLMSAttributeSettings"))
                {
                    att = new DLMSAttribute();
            ...
            else if(event==XMLStreamConstants.END_ELEMENT)
            {
                ...
                {
                    man.setInactivityMode(com.aimir.fep.bypass.dlms.manufacturersettings.InactivityMode.valueOf(data.toUpperCase()));
                }
                else if(target.equalsIgnoreCase("Type"))
                {
                    if (authentication != null)
                    {
                        authentication.setType(com.aimir.fep.bypass.dlms.enums.Authentication.valueOf(data.toUpperCase()));
                    }
                    else
                    {
                        if (data.equals("BinaryCodedDesimal"))
                        {
                            att.setType(com.aimir.fep.bypass.dlms.enums.DataType.BCD);
                        }
                        else if (data.equals("OctetString"))
                        {
                            att.setType(com.aimir.fep.bypass.dlms.enums.DataType.OCTET_STRING);
                        }
                        else
                        {
                            att.setType(com.aimir.fep.bypass.dlms.enums.DataType.valueOf(data.toUpperCase()));
                        }
                    }
                }
                 else if(target.equalsIgnoreCase("UIType"))
                {
                    ...
                    {
                        att.setUIType(com.aimir.fep.bypass.dlms.enums.DataType.valueOf(data.toUpperCase()));
                    }
                }
                else if(target.equalsIgnoreCase("Authentication"))
                {
