...
import com.aimir.fep.bypass.dlms.enums.ControlMode;
import com.aimir.fep.bypass.dlms.enums.ControlState;
import com.aimir.fep.bypass.dlms.enums.DataType;
import com.aimir.fep.bypass.dlms.enums.ObjectType;

public class DLMSDisconnectControl extends DLMSObject implements DLMSBase
{
    ...
    */
    public DLMSDisconnectControl(String ln)
    {
    ...
    */
    public DLMSDisconnectControl(String ln, int sn)
    {
    ...
    */
    public byte[][] remoteDisconnect(DLMSClient client)
    {
     ...
     */
    public byte[][] remoteReconnect(DLMSClient client)
    {
