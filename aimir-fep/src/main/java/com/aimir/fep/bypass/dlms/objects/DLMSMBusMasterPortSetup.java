...
public class DLMSMBusMasterPortSetup extends DLMSObject implements DLMSBase
{
    ...
    /**  
     Constructor.
    */
    public DLMSMBusMasterPortSetup()
    {
    ...
    */
    public DLMSMBusMasterPortSetup(String ln)
    {
    ...
    */
    public DLMSMBusMasterPortSetup(String ln, int sn)
    {
