...
public class DLMSSapAssignment extends DLMSObject implements DLMSBase
{
    ...
    */
    public DLMSSapAssignment(String ln)
    {
    ...
    */
    public DLMSSapAssignment(String ln, int sn)
    {
            ...
            if (cnt != 0)
            {
                ...
                {                    
                    for (AbstractMap.SimpleEntry<Integer, String> it : m_SapAssignmentList)
                    {
                        ...
                        Common.setData(data, DataType.UINT16, it.getKey());
                        Common.setData(data, DataType.OCTET_STRING, Common.getBytes(it.getValue()));
                    }
                }
                catch(Exception ex)
                {
        ...
        else if (index == 2)
        {
            ...
            {                    
                for (Object item : (Object[])value)
                {
                    ...
                    {
                        str = DLMSClient.changeType((byte[])tmp, DataType.STRING).toString();
                    }
                    else
                    {
                        str = tmp.toString();
