...
public class ObisCode
{
    ...
    */
    ...
    public ObisCode()
    {
        privateAttributes = new AttributeCollection();
    ...
    /** 
     Constructor.
    */
    public ObisCode(String ln, ObjectType objectType, int index)
    {
        setLogicalName(ln);
    ...
    /** 
     Constructor.
    */
    public ObisCode(String ln, ObjectType objectType, String description)
    {
        setLogicalName(ln);
        setObjectType(objectType);
    ...
    */
    ...
    public final void setAttributes(AttributeCollection value)
    {
        privateAttributes = value;
    }

    public static java.lang.Class getDataType(com.aimir.fep.bypass.dlms.enums.DataType type)
    {
        switch (type)
        {
        case ARRAY:
