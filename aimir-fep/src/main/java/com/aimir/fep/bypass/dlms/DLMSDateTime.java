...
//
// More information of Gurux DLMS/COSEM Director: http://www.gurux.org/DLMSDirector
//
...
public class DLMSDateTime
{
    ...
    */
    ...
    /** 
     Constructor.
    */
    public DLMSDateTime(java.util.Date value)
    {
        Skip = EnumSet.noneOf(DateTimeSkips.class);
        setValue(value);
        Status = ClockStatus.OK;
    ...
    /** 
     Constructor.
    */        
    public DLMSDateTime(int year, int month, int day, int hour, int minute, int second, int millisecond)
    {
        Status = ClockStatus.OK;
        Skip = EnumSet.noneOf(DateTimeSkips.class);
