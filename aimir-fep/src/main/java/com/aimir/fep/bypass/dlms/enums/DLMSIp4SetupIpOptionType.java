...
public enum DLMSIp4SetupIpOptionType
{
    ...
    */
    ...
    private static java.util.HashMap<Integer, DLMSIp4SetupIpOptionType> mappings;
    private static java.util.HashMap<Integer, DLMSIp4SetupIpOptionType> getMappings()
    {
        if (mappings == null)
        {
            synchronized (DLMSIp4SetupIpOptionType.class)
            {
                if (mappings == null)
                {
                    mappings = new java.util.HashMap<Integer, DLMSIp4SetupIpOptionType>();
                }
            }
        }
        return mappings;
    ...
    private DLMSIp4SetupIpOptionType(int value)
    {
        intValue = value;
    ...
    public static DLMSIp4SetupIpOptionType forValue(int value)
    {
