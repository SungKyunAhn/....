...
import com.aimir.fep.bypass.dlms.enums.SecurityPolicy;
import com.aimir.fep.bypass.dlms.enums.SecuritySuite;

public class DLMSSecuritySetup extends DLMSObject implements DLMSBase
{
    ...
    */
    public DLMSSecuritySetup(String ln)
    {
    ...
    */
    public DLMSSecuritySetup(String ln, int sn)
    {
