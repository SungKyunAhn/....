...
public class DLMSDemandRegister extends DLMSObject implements DLMSBase
{
    ...
    private DLMSDateTime m_CaptureTime = new DLMSDateTime();
    private DLMSDateTime m_StartTimeCurrent = new DLMSDateTime();
    ...
    */
    public DLMSDemandRegister(String ln)
    {
        this(ln, 0);
    }
    ...
    */
    public DLMSDemandRegister(String ln, int sn)
    {
    ...
    */
    ...
    public final void setCaptureTime(DLMSDateTime value)
    {
        m_CaptureTime = value;
    }
    ...
    */
    ...
    public final void setStartTimeCurrent(DLMSDateTime value)
    {
    ...
    {    
        ...
        if (index == 4)
        {
            ...
            try 
            {                
                Common.setData(data, DataType.INT8, m_Scaler);            
                Common.setData(data, DataType.ENUM, m_Unit);
                return data.toByteArray();
            }
            catch (Exception ex) 
            {
                Logger.getLogger(DLMSRegister.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public void setValue(int index, Object value)
    {
        ...
        else if (index == 6)
        {
            ...
            else
            {
                ...
                setCaptureTime((DLMSDateTime) value);
            }
        }
        else if (index == 7)
        {
            ...
            else
            {
                ...
                setStartTimeCurrent((DLMSDateTime) value);
            }
        }
        else if (index == 8)
        {
        ...
        else if (index == 9)
        {
            ...
            {
                setNumberOfPeriods(Common.intValue(value));
            }
        }   
        else
        {
