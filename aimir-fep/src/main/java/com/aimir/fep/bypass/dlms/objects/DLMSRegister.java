...
public class DLMSRegister extends DLMSObject implements DLMSBase
{
...
public DLMSRegister(ObjectType type, String ln, int sn)
{
    super(type, ln, sn);
    setScaler(1);
    setUnit(Unit.NONE);
    ...
    */
    public DLMSRegister(String ln, int sn)
    {
    ...
    */
     ...
     * Reset value.
     */
    public byte[][] reset(DLMSClient client)
    {
    ...
    public DataType getDataType(int index)
    {
        ...
        if (index == 4 && this instanceof DLMSExtendedRegister)
        {
            return super.getDataType(index);
        }  
