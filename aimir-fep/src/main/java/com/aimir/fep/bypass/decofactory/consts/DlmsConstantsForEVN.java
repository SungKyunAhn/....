 ...
 *
 */
public class DlmsConstantsForEVN {
	private static Logger logger = LoggerFactory.getLogger(DlmsConstantsForEVN.class);
	...
	public enum AARQ {
		...
		, CALLING_AE_QUALIFIER(7, ""), CALLING_AP_INVOCATION_ID(8, ""), CALLING_AE_INVOCATION_ID(9, ""), SENDER_ACSE_REQUIREMENTS(10, "8A020780"), MECHANISM_NAME(11, "8B0760857405080201"), CALLING_AUTHENTICATION_VALUE(12, "AC0A8008" + "3333333333333333") //   -- CtoS(challenge)
		, IMPLEMENTATION_INFORMATION(29, ""), USER_INFORMATION(30, "BE10040E01000000065F1F0400007E1F00AC"), APPLICATION(97, "60"), AARQ_LLC(98, "E6E600");
