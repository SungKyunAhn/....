...
public class GetSpecificMonthNetChargeRes extends STSDataFrame {
    private static Log log = LogFactory.getLog(GetSpecificMonthNetChargeRes.class);
    
    private int m_consumption = 0;
    private double m_cost = 0.0;
    
    public GetSpecificMonthNetChargeRes(byte[] bx) throws Exception {
        super.decode(bx);
        parse();
    }
