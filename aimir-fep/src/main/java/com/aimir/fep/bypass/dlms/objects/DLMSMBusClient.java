...
public class DLMSMBusClient extends DLMSObject implements DLMSBase
{
    ...
    */
    public DLMSMBusClient(String ln)
    {
    ...
    */
    public DLMSMBusClient(String ln, int sn)
    {
...
*/
    ...
    public void setValue(int index, Object value)
    {
        ...
        {
            MBusPortReference = DLMSClient.changeType((byte[])value, DataType.OCTET_STRING).toString();
        }
        else if (index == 3)
        {
            ...
            {                    
                CaptureDefinition.add(new AbstractMap.SimpleEntry<String, String>(DLMSClient.changeType((byte[])Array.get(it, 0), DataType.OCTET_STRING).toString(),
                    DLMSClient.changeType((byte[])Array.get(it, 1), DataType.OCTET_STRING).toString()));
            }            
        }
        else if (index == 4)
        {
        ...
        {
            ManufacturerID = (Integer)value;
        }
        else if (index == 8)
        {
            DataHeaderVersion = (Integer)value;
        }
        else if (index == 9)
        {
