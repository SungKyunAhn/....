...
import com.aimir.fep.bypass.decofactory.consts.DlmsConstantsForMOE.CurrentLoadLimitAttributes;
					...
					case NORMAL:
						...
						if (aResult == GetDataResult.DATA) {
							...
							case UINT16:
								...
								System.arraycopy(information, infoPos, data, 0, data.length);
								infoPos += data.length;
								long long16Result = Long.parseLong(String.valueOf(DlmsConstantsForMOE.getValueByDLMSCommonDataType(DLMSCommonDataType.UINT16, data)));
