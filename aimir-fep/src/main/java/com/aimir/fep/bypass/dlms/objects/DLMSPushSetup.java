...
{
    private java.util.ArrayList<DLMSPushObject> PushObjectList;
    private SendDestinationAndMethod SendDestinationAndMethod;
    private java.util.ArrayList<java.util.Map.Entry<DLMSDateTime, DLMSDateTime>> CommunicationWindow;
    ...
    */
    public DLMSPushSetup()
    {
        ...
        PushObjectList = new java.util.ArrayList<DLMSPushObject>();
        SendDestinationAndMethod = new SendDestinationAndMethod();
        CommunicationWindow = new java.util.ArrayList<java.util.Map.Entry<DLMSDateTime, DLMSDateTime>>();
    }
    ...
    */
    public DLMSPushSetup(String ln)
    {
    ...
    */
    public DLMSPushSetup(String ln, int sn)
    {
...
*/
    public final java.util.ArrayList<DLMSPushObject> getPushObjectList()
    {
    ...
    */
    public final java.util.ArrayList<java.util.Map.Entry<DLMSDateTime, DLMSDateTime>> getCommunicationWindow()
    {
        ...
        else if (index == 2)
        {
            ...
            if (value instanceof Object[])
            {
                for (Object it : (Object[])value)
                {
                    ...
                    DLMSPushObject obj = new DLMSPushObject();
                    obj.setType(ObjectType.forValue(((Number)tmp[0]).intValue()));
                    obj.setLogicalName(DLMSClient.changeType((byte[])tmp[1], DataType.BITSTRING).toString());
        ...
        else if (index == 4)
        {
            ...
            if (value instanceof Object[])
            {
                for (Object it : (Object[])value)
                {
                    ...
                    CommunicationWindow.add(new SimpleEntry<DLMSDateTime, DLMSDateTime>(start, end));
                }
            }
        }
        else if (index == 5)
