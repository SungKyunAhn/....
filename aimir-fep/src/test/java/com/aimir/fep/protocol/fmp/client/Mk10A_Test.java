...
public class Mk10A_Test extends BaseTestCase {
	static {
        DataUtil.setApplicationContext(new ClassPathXmlApplicationContext(new String[]{"/config/spring.xml"}));
    }
    private static Log log = LogFactory.getLog(Mk10A_Test.class);
    ...
    public void ondemandTest(){
    		...
    		try {
    			//cgw.cmdOnDemandMeter("", "210075113", "Nuri-dc175a15", "0", "20120502000000", "20120502000000");
    			cgw.cmdOnDemandMeter("", "210075113", "Nuri-dc175a19", "0", TimeUtil.getCurrentDay()+"000000", TimeUtil.getCurrentDay()+"000000");
