...
public class DLMSKaifaMeterDataLPTimeDuplicateandValueDiffTest {
    private static Log log = LogFactory.getLog(DLMSKaifaMeterDataLPTimeDuplicateandValueDiffTest.class);
    
    
    public static void main(String[] args) { 
    	DLMSKaifaMeterDataLPTimeDuplicateandValueDiffTest test = new DLMSKaifaMeterDataLPTimeDuplicateandValueDiffTest();
    	test.test_dlms();
    }
