 ...
 */
public class ST025Short extends ST025 implements java.io.Serializable {
	private static final long serialVersionUID = 7615240596513538304L;
	...
	private final int SHORT_TOTAL_SIZE = 19;
	...
	private byte[] data;
    private static Log log = LogFactory.getLog(ST025Short.class);
	 ...
	 */
	public ST025Short(byte[] data, int nbr_tiers, int nbr_sum, int nbr_dmd, int nbr_coin,
