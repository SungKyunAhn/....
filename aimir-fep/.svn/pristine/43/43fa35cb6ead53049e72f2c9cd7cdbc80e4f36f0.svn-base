 ...
 *
 */
public class A1830RLN_ReceiveDataFrame extends ReceiveDataFrame
{
    private static Log log = LogFactory.getLog(A1830RLN_ReceiveDataFrame.class);
     ...
     * constructor
     */
    public A1830RLN_ReceiveDataFrame()
    {
    }
    
    public A1830RLN_ReceiveDataFrame(byte[] receiveBytes) {
