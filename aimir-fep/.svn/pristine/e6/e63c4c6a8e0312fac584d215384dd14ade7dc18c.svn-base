...
public class ReqContainer extends Request {
	
	private String cseBase;
	private String remoteCSEName;
	private String containerName;
	
	public ReqContainer(String cseBase, String remoteCSEName,
	...
	public ReqContainer(String cseBase, String remoteCSEName, String containerName,
