 ...
 * @author Kang, Soyi
 */
public class LK1210DRB_DataConstants
{
...
//  DLMS Message Def
    ...
    public static final byte 	MSAP_SRC_ADDRESS	=(byte)0x21;
...
//Class_id + OBIS Code + Attribute : 2 Byte + 6 Byte + 1 Byte
     ...
     * constructor
     */
    public LK1210DRB_DataConstants()
    {
    }
    ...
    public static char DLMS_Fcs16(char fcs, byte[] baData, int npos, int len )
    {
    	...
    	while(0<len-- ){
    		fcs = (char)((byte)(fcs >> 8) ^ fcstab[(char)((fcs ^ baData[npos++]) & 0xff)]);
    	}
