...
public class A3RLNQ_RequestDataFrame extends RequestDataFrame{
	
    @SuppressWarnings("unused")
    private static Log log = LogFactory.getLog(A3RLNQ_RequestDataFrame.class);
    public byte kind;
     ...
     * constructor
     */
    public A3RLNQ_RequestDataFrame()
    {
    }
    
    public A3RLNQ_RequestDataFrame(byte before_txd_control, byte kind, byte meter_cmd, int len, int meter_length)
    {
        this.kind = kind;
    ...
    public A3RLNQ_RequestDataFrame(byte before_txd_control, byte kind, byte meter_cmd, OCTET msg, int len, int meter_length)
    {
        this.kind = kind;
        this.meter_cmd = meter_cmd;
        this.msg = msg;
    ...
    public A3RLNQ_RequestDataFrame(byte before_txd_control, byte kind, byte meter_cmd, OCTET msg,
