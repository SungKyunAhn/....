...
public class DLMSKaifaMeterDataLPDuplicateTest {
    private static Log log = LogFactory.getLog(DLMSKaifaMeterDataLPDuplicateTest.class);
    
    
    public static void main(String[] args) { 
    	DLMSKaifaMeterDataLPDuplicateTest test = new DLMSKaifaMeterDataLPDuplicateTest();
    	test.test_dlms();
    }
