...
public class ST76 implements java.io.Serializable{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 1139490529759899621L;
...
//									DataFormat.select(b,offset,len))) & 0x10;
			...
			if(kind == 0){
				...
				switch(evcode){
					case 2048: msg = "MFG Enter Tier Override";
						break;
					case 2049: msg = "MFG Exit Tier Override";
						break;
					case 2050: msg = "MFG Terminal cover tamper";
						break;
					case 2051: msg = "MFG Main cover tamper";
						break;
					case 2052: msg = "MFG External Event 0";
						break;
					case 2053: msg = "MFG External Event 1";
						break;
					case 2054: msg = "MFG External Event 2";
						break;
					case 2055: msg = "MFG External Event 3";
						break;
					case 2056: msg = "MFG Phase A OFF";
						break;
					case  2057: msg = "MFG Phase A ON";
						break;
					case 2058: msg = "MFG Phase B OFF";
						break;
					case 2059: msg = "MFG Phase B ON";
						break;
					case 2060: msg = "MFG Phase C OFF";
						break;
					case 2061: msg = "MFG Phase C ON";
						break;
				}
			}
