/** 
 * @(#)Class11.java       1.0 04/09/16 *
 * 
 * Billing Data Class (Current)
...
public class Class11 {
	 ...
	 * TOU block 1
	 * Rate A
	 * Get Maximum Demand Date and Time.<p>
	 * @return - 8 byte hex data.
	 */
	...
	public byte[] parseAKWCUM1() throws Exception {
		return DataFormat.dec2hex(DataFormat.bcd2long(data,OFS_AKWCUM1,LEN_AKWCUM1));
	}
	 ...
	 * TOU block 1
	 * Rate B 
	 * Get Maximum Demand Date and Time.
	 * @return - 8 byte hex data.
	 */
	...
	public byte[] parseBKWCUM1() throws Exception {
		return DataFormat.dec2hex(DataFormat.bcd2long(data,OFS_BKWCUM1,LEN_BKWCUM1));
	}
	...
	public byte[] parseCKWH1() throws Exception {
		return DataFormat.dec2hex(DataFormat.bcd2long(data,OFS_CKWH1,LEN_CKWH1));		
	}
	...
	public byte[] parseCKWCUM1() throws Exception {
		return DataFormat.dec2hex(DataFormat.bcd2long(data,OFS_CKWCUM1,LEN_CKWCUM1));
	}
	...
	public byte[] parseDKWCUM1() throws Exception {
		return DataFormat.dec2hex(DataFormat.bcd2long(data,OFS_DKWCUM1,LEN_DKWCUM1));
	}
	...
	public byte[] parseAKWH2() throws Exception {
		return DataFormat.dec2hex(DataFormat.bcd2long(data,OFS_AKWH2,LEN_AKWH2));
	}
	...
	public byte[] parseAKWCUM2() throws Exception {
		return DataFormat.dec2hex(DataFormat.bcd2long(data,OFS_AKWCUM2,LEN_AKWCUM2));
	}
	...
	public byte[] parseBKWH2() throws Exception {
		return DataFormat.dec2hex(DataFormat.bcd2long(data,OFS_BKWH2,LEN_BKWH2));
	}
	...
	public byte[] parseBKWCUM2() throws Exception {
		return DataFormat.dec2hex(DataFormat.bcd2long(data,OFS_BKWCUM2,LEN_BKWCUM2));
	}
	...
	public byte[] parseCKWH2() throws Exception {
		return DataFormat.dec2hex(DataFormat.bcd2long(data,OFS_CKWH2,LEN_CKWH2));
	}
	...
	public byte[] parseCKWCUM2() throws Exception {
		return DataFormat.dec2hex(DataFormat.bcd2long(data,OFS_CKWCUM2,LEN_CKWCUM2));
	}
	...
	public byte[] parseDKWCUM2() throws Exception {
		return DataFormat.dec2hex(DataFormat.bcd2long(data,OFS_DKWCUM2,LEN_DKWCUM2));
	}
	...
	public byte[] parseETKWH1() throws Exception {
		return DataFormat.dec2hex(DataFormat.bcd2long(data,OFS_ETKWH1,LEN_ETKWH1));
	}
	...
	public byte[] parseETKWH2() throws Exception {
		return DataFormat.dec2hex(DataFormat.bcd2long(data,OFS_ETKWH2,LEN_ETKWH2));
	}
	...
	public double parseEKVARH4() throws Exception {
		return DataFormat.bcd2long(data,OFS_EKVARH4,LEN_EKVARH4)*Math.pow(-10,6);
	}
	...
	public double parseEKVARH3() throws Exception {
		return DataFormat.bcd2long(data,OFS_EKVARH3,LEN_EKVARH3)*Math.pow(-10,6);
	}
	...
	public double parseEKVARH2() throws Exception {
		return DataFormat.bcd2long(data,OFS_EKVARH2,LEN_EKVARH2)*Math.pow(-10,6);
	}
	...
	public double parseEKVARH1() throws Exception {
		return DataFormat.bcd2long(data,OFS_EKVARH1,LEN_EKVARH1)*Math.pow(-10,6);
	}
