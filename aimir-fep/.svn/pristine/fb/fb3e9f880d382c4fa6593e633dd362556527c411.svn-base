...
/** 
 DLMS implements methods to communicate with DLMS/COSEM metering devices.
*/
public class DLMSClient
{
    ...
    */
    public DLMSClient()
    {        
        this.setAuthentication(com.aimir.fep.bypass.dlms.enums.Authentication.NONE);
    }
    ...
    /** 
     ...
     @param intefaceType
    */
    public DLMSClient(boolean useLogicalNameReferencing,             
            Object clientID,
            Object serverID,            
            com.aimir.fep.bypass.dlms.enums.Authentication authentication,             
            String password,
    ...
    public void setObjects(DLMSObjectCollection value)
    {
        Objects = value;
    }
    ...
    */
    ...
    public final void setObisCodes(ObisCodeCollection value)
    {
    ...
    */
    ...
    /** 
     ...
     @see DLMSClient#getClientID()
     @see DLMSClient#getServerID
     @see DLMSClient#getDLMSVersion
     @see DLMSClient#getUseLogicalNameReferencing
    */
    ...
    */
    ...
    /** 
     ...
     @see DLMSClient#getAuthentication
    */
    ...
    */
    ...
    /** 
     ...
     @see DLMSClient#getPassword
     @see DLMSClient#getClientID
     @see DLMSClient#getServerID
     @see DLMSClient#getDLMSVersion
     @see DLMSClient#getUseLogicalNameReferencing
     @see DLMSClient#getMaxReceivePDUSize
    */
    ...
    */
    ...
    {    
        return Common.toHex(bytes, index, count);
    } 
    ...
    /** 
     ...
     @see DLMSClient#getClientID
     @see DLMSClient#getServerID
     @see DLMSClient#parseUAResponse
    */
    ...
    */
    public final void parseUAResponse(byte[] data)
    {
        ...
        {
            throw new DLMSException("Not a UA response :" + frame[0]);
        }
    ...
    /** 
     ...
     @see DLMSClient#parseAAREResponse     
     @see DLMSClient#isDLMSPacketComplete
    */
    public final byte[][] AARQRequest(DLMSTagCollection Tags)
    {           
        java.nio.ByteBuffer buff = java.nio.ByteBuffer.allocate(200);
        m_Base.checkInit();
        APDU aarq = new APDU(Tags);
        aarq.setUseLN(this.getUseLogicalNameReferencing());        
        if (this.getUseLogicalNameReferencing())
        {
            m_Base.setSNSettings(null);
            m_Base.setLNSettings(new DLMSLNSettings(new byte[] {0x00, 0x7E, 0x1F}));
            aarq.userInformation.conformanceBlock = getLNSettings().conformanceBlock;
        }
        else
        {
            m_Base.setLNSettings(null);
            m_Base.setSNSettings(new DLMSSNSettings(new byte[] {0x1C, 0x03, 0x20}));
        ...
        {
            m_Base.CtoSChallenge = DLMS.generateChallenge();
        }
        else
        {
    ...
    /** 
     ...
     @see DLMSClient#AARQRequest
     @see DLMSClient#getUseLogicalNameReferencing
     @see DLMSClient#getDLMSVersion
     @see DLMSClient#getMaxReceivePDUSize
     @see DLMSClient#getLNSettings
     @see DLMSClient#getSNSettings
    */
    public final DLMSTagCollection parseAAREResponse(byte[] reply)
    {
        byte[] frame = new byte[1];
        int[] error = new int[1];
        ByteArrayOutputStream tmp = new ByteArrayOutputStream();        
        ...
        //Parse AARE data.
        DLMSTagCollection Tags = new DLMSTagCollection();
        APDU pdu = new APDU(Tags);
        pdu.encodeData(arr);
        ...
        if (ret == AssociationResult.ACCEPTED)
        {
            ...
            {
                m_Base.setLNSettings(new DLMSLNSettings(pdu.userInformation.conformanceBlock));
            }
            else
            {
                m_Base.setSNSettings(new DLMSSNSettings(pdu.userInformation.conformanceBlock));
            }
        ...
        else
        {
           m_Base.setLNSettings(null);
           m_Base.setSNSettings(null);
           throw new DLMSException(ret, pdu.getResultDiagnosticValue());
        }
    ...
    public byte[][] getApplicationAssociationRequest()
    {
        ...
        byte[] challenge = DLMSServerBase.chipher(getAuthentication(), CtoS.toByteArray());
        if (getUseLogicalNameReferencing())
        {
    ...
    public void parseApplicationAssociationResponse(byte[] reply)
    {
        ...
        byte[] serverChallenge = (byte[]) Common.getData(tmp.toByteArray(), index, 
        ...
        byte[] clientChallenge = DLMSServerBase.chipher(getAuthentication(), challenge.toByteArray());
        int[] pos = new int[1];
    ...
    */
    ...
    /** 
     ...
     @return 
    */
    private DLMSObject createDLMSObject(int ClassID, Object Version, int BaseName, Object LN, Object AccessRights)
    {
        ObjectType type = ObjectType.forValue(ClassID);
        DLMSObject obj = createObject(type); 
        updateObjectData(obj, type, Version, BaseName, (byte[])LN, AccessRights);
        if (getObisCodes() != null)
        {
            ObisCode code = getObisCodes().findByLN(obj.getObjectType(), obj.getLogicalName(), null);
            if (code != null)
            {
    ...
    /** 
     Reserved for internal use.
    */
    private DLMSObjectCollection parseSNObjects(byte[] buff, boolean onlyKnownObjects)
    {
        int[] index = new int[1];
        //Get array tag.
        ...
        DLMSObjectCollection items = new DLMSObjectCollection(this);
        long cnt = Common.getObjectCount(buff, index);
        int[] total = new int[1], count = new int[1];
        for (long objPos = 0; objPos != cnt; ++objPos)
        {
            DataType[] type = new DataType[]{DataType.NONE};
            int[] cachePosition = new int[1];
            Object[] objects = (Object[])Common.getData(buff, index, 
                    ActionType.NONE.getValue(), total, count, type, cachePosition);
            if (index[0] == -1)
            {
            ...
            if (baseName > 0)
            {
                DLMSObject comp = createDLMSObject(classID, objects[2], baseName, objects[3], null);
                if (!onlyKnownObjects || comp.getClass() != DLMSObject.class)
                {
                    items.add(comp);
                }
                else
    ...
    /** 
     ...
     @param dataIndex
    */
    final void updateObjectData(DLMSObject obj, ObjectType objectType, Object version, Object baseName, byte[] logicalName, Object accessRights)
    {
        ...
        obj.setLogicalName(DLMSObject.toLogicalName(logicalName));        
    }
    ...
    */
    public final DLMSObjectCollection parseObjects(ByteArrayOutputStream data, boolean onlyKnownObjects)
    {
        return parseObjects(data.toByteArray(), onlyKnownObjects);
    }
        
    static void updateOBISCodes(DLMSObjectCollection objects)
    {        
        InputStream stream = DLMSClient.class.getResourceAsStream("/resources/OBISCodes.txt");
        if (stream == null)
        {
            return;
        }
        ...
        {
            Logger.getLogger(DLMSClient.class.getName()).log(Level.SEVERE, null, ex);
        }        
        String str = buffer.toString();        
        StandardObisCodeCollection codes = new StandardObisCodeCollection();
        String[] rows = str.split("\r\n");
        for (String it : rows)
        {
            String[] items = it.split("[;]", -1);
            String[] obis = items[0].split("[.]", -1);
            StandardObisCode code = new StandardObisCode(obis, items[3] + "; " + items[4] + "; " + items[5] + "; " + items[6] + "; " + items[7], items[1], items[2]);
            codes.add(code);
        }
        for (DLMSObject it : objects)
        {
            ...
            StandardObisCode code = codes.find(ln, it.getObjectType());
            if (code != null)
            {
                ...
                else if (code.getDataType().contains("9"))
                {
                    ...
                    if ((StandardObisCodeCollection.equalsMask("0.0-64.96.7.10-14.255", ln) ||
                        //Time stamps of the billing periods objects (second scheme)
                        StandardObisCodeCollection.equalsMask("0.0-64.0.1.5.0-99,255", ln) ||
                        //Time of power failure
                        StandardObisCodeCollection.equalsMask("0.0-64.0.1.2.0-99,255", ln) ||
                        //Time stamps of the billing periods objects (first scheme if there are two)                        
                        StandardObisCodeCollection.equalsMask("1.0-64.0.1.2.0-99,255", ln) ||
                        //Time stamps of the billing periods objects (second scheme)
                        StandardObisCodeCollection.equalsMask("1.0-64.0.1.5.0-99,255", ln) ||
                        //Time expired since last end of billing period
                        StandardObisCodeCollection.equalsMask("1.0-64.0.9.0.255", ln) ||                        
                        //Time of last reset
                        StandardObisCodeCollection.equalsMask("1.0-64.0.9.6.255", ln) ||
                        //Date of last reset
                        StandardObisCodeCollection.equalsMask("1.0-64.0.9.7.255", ln) ||
                        //Time expired since last end of billing period (Second billing period scheme)
                        StandardObisCodeCollection.equalsMask("1.0-64.0.9.13.255", ln) ||                        
                        //Time of last reset (Second billing period scheme)
                        StandardObisCodeCollection.equalsMask("1.0-64.0.9.14.255", ln) ||
                        //Date of last reset (Second billing period scheme)
                        StandardObisCodeCollection.equalsMask("1.0-64.0.9.15.255", ln)))
                    {
                        code.setDataType("25");
                    }
                    //Local time
                    else if (StandardObisCodeCollection.equalsMask("1.0-64.0.9.1.255", ln))
                    {
                        code.setDataType("27");
                    }
                    //Local date
                    else if (StandardObisCodeCollection.equalsMask("1.0-64.0.9.2.255", ln))
                    {
                        code.setDataType("26");
                    }
                }
    ...
    /** 
     ...
     @return Collection of COSEM objects.
    */
    public final DLMSObjectCollection parseObjects(byte[] data, boolean onlyKnownObjects)
    {
        if (data == null)
        {
     ...
     @return Collection of COSEM objects.
    */
    public final DLMSObjectCollection parseObjects(java.nio.ByteBuffer data, boolean onlyKnownObjects)
    {
    ...
    /** 
     Reserved for internal use.
    */
    private DLMSObjectCollection parseLNObjects(byte[] buff, boolean onlyKnownObjects)
    {
        int[] index = new int[1];
        //Get array tag.
        byte size = buff[index[0]++];
        ...
        for (long objPos = 0; objPos != cnt; ++objPos)
        {
            ...
            if (classID > 0)
            {
                DLMSObject comp = createDLMSObject(classID, objects[1], 0, 
                        objects[2], objects[3]);
                if (!onlyKnownObjects || comp.getClass() != DLMSObject.class)
                {
                    items.add(comp);
                ...
                else
                {
                    System.out.println(String.format("Unknown object : %d %s", 
                            classID, DLMSObject.toLogicalName((byte[]) objects[2])));                    
                }
            }
        }
        return items;
    ...
    public final List<AbstractMap.SimpleEntry<DLMSObject, DLMSCaptureObject>> parseColumns(ByteArrayOutputStream data)
    {        
    ...
    */
    public final List<AbstractMap.SimpleEntry<DLMSObject, DLMSCaptureObject>> parseColumns(byte[] data)
    {
        if (data == null)
        {
            throw new DLMSException("Invalid parameter.");
        ...
        //get object count
        int cnt = Common.getObjectCount(data, index);
        int objectCnt = 0;
        List<AbstractMap.SimpleEntry<DLMSObject, DLMSCaptureObject>> items = 
                new ArrayList<AbstractMap.SimpleEntry<DLMSObject, DLMSCaptureObject>>();        
        int[] total = new int[1], count = new int[1];
        DLMSObjectCollection objects2 = new DLMSObjectCollection();
        while (index[0] != data.length && cnt != objectCnt)
        {
            DataType[] type = new DataType[]{DataType.NONE};
            int[] cachePosition = new int[1];
            Object[] objects = (Object[])Common.getData(data, index, 
                    ActionType.NONE.getValue(), total, count, type, cachePosition);
            if (index[0] == -1)
            {
                throw new OutOfMemoryError();
            ...
            ++objectCnt;
            DLMSObject comp = createDLMSObject(((Number)objects[0]).shortValue(), 
                    null, 0, objects[1], 0);
            if (comp != null)
            {
                DLMSCaptureObject co = new DLMSCaptureObject(((Number)objects[2]).shortValue(), ((Number)objects[3]).shortValue());                
                items.add(new AbstractMap.SimpleEntry<DLMSObject, DLMSCaptureObject>(comp, co));
                objects2.add(comp);
                //Update data type and scaler unit if register.
                if (Objects != null)
                {
                    DLMSObject tmp = Objects.findByLN(comp.getObjectType(), comp.getLogicalName());
                    if (tmp != null)
                    {
                        if (comp instanceof DLMSRegister)
                        {
                            ...
                            ((DLMSRegister) comp).setScaler(((DLMSRegister) tmp).getScaler());
                            ((DLMSRegister) comp).setUnit(((DLMSRegister) tmp).getUnit());
                        }
                    }
                }
            }            
     ...
     */
    public final Object updateValue(byte[] data, DLMSObject target, int attributeIndex) throws Exception
    {
     ...
     * Get Value from byte array received from the meter.
     */
    public final Object getValue(byte[] data, DLMSObject target, int attributeIndex) throws Exception
    {        
        ...
        if (value instanceof byte[])
        {
            ...
            return DLMSClient.changeType((byte[]) value, type);
        }            
        return value;
    }
     ...
     * Get Value from byte array received from the meter.
     */
    public final Object getValue(ByteArrayOutputStream data, DLMSObject target, int attributeIndex) throws Exception
    {
    ...
    */
    public final Object getValue(byte[] data, ObjectType type, String ln, int attributeIndex) throws Exception
    {
        ...
        if (value instanceof byte[])
        {
            ...
            if (attributeIndex == 1)
            {
                return DLMSClient.changeType((byte[]) value, DataType.OCTET_STRING);
            }
            ...
            if (getObisCodes() != null)
            {
                ObisCode code = getObisCodes().findByLN(type, ln, null);
                if (code != null)
                {
                    DLMSAttributeSettings att = code.getAttributes().find(attributeIndex);
    ...
    */
    public final Object tryGetValue(byte[] data)
    {
        ...
        try
        {
            ...
            //Object value = Common.GetData(data, ActionType.NONE, total, read, type, ref m_Base.CacheIndex);            
            int[] cachePosition = new int[] {m_Base.cacheIndex};
            Object value = Common.getData(data, index, ActionType.NONE.getValue(), 
    ...
    */
    public static Object changeType(byte[] value, DataType type)
    {
        ...
        int[] cachePosition = new int[1];
        Object ret = Common.getData(value, index, ActionType.NONE.getValue(), 
                total, count, tp, cachePosition);
        if (index[0] == -1)
        {
            System.out.println(Common.toHex(value));
            throw new OutOfMemoryError();
        }
    ...
    */
     public final byte[][] method(DLMSObject item, int index, Object data, DataType type)
    {
    ...
    */    
    public final byte[][] method(Object name, ObjectType objectType, int index, Object data, int parameterCount, DataType type)
    {
        ...
        if (!getUseLogicalNameReferencing())
        {
            ...
            DLMS.getActionInfo(objectType, value, count);
            if (index > count[0])
            {
     ...
     */
    public final byte[][] write(DLMSObject item, 
            int index)
    ...
    */
            ...
            throws RuntimeException, UnsupportedEncodingException, ParseException
    {
        ...
        {
            type = Common.getValueType(value);
            if (type == DataType.NONE)
            {
        ...
        ByteArrayOutputStream buff = new ByteArrayOutputStream();
        Common.setData(buff, type, value);
        m_Base.clearProgress();
    ...
    */
    ...
    /** 
     ...
     @return Read request as byte array.
    */
    public final byte[][] read(DLMSObject item, int attributeOrdinal)
    {
    ...
    */
    public final byte[] readRowsByEntry(Object name, int index, int count)
    {
        ...
        Common.setData(buff, DataType.UINT32, index); //Add start index
        Common.setData(buff, DataType.UINT32, count); //Add Count
        Common.setData(buff, DataType.UINT16, 1); //Read all columns.
        Common.setData(buff, DataType.UINT16, 0);
    ...
    */
    ...
    {                
        ...
        buff.put((byte) 0x04); //Add item count
        Common.setData(buff, DataType.UINT16, (short)8); // Add class_id
        Common.setData(buff, DataType.OCTET_STRING, sortedLn); // Add parameter Logical name
        Common.setData(buff, DataType.INT8, 2);// Add attribute index.
        Common.setData(buff, DataType.UINT16, sortedVersion); // Add version
        Common.setData(buff, DataType.DATETIME, start); // Add start time
        Common.setData(buff, DataType.DATETIME, end); // Add start time
     ...
     */
    static public DLMSObject createObject(ObjectType type)
    {
        return DLMS.createObject(type);
    }
