...
import com.aimir.fep.meter.parser.DLMSGtypeLSTable.DLMSGtypeVARIABLE.MONTHLY_ENERGY_PROFILE;
import com.aimir.fep.meter.parser.DLMSKepcoTable.LPComparator;
import com.aimir.fep.meter.parser.DLMSGtypeLSTable.DLMSGtypeTable;
...
import com.aimir.fep.meter.parser.DLMSGtypeLSTable.DLMSGtypeVARIABLE.POWER_QUALITY;
...
public class DLMSGtypeLS extends MeterDataParser implements java.io.Serializable {

	private static final long serialVersionUID = 8916023997892795309L;

	private static Log log = LogFactory.getLog(DLMSGtypeLS.class);
    ...
    public void setLPData(LPData lastLp) {
        try {
            ...
            if (lpData.length > 0) {
        	    ...
        	    _lpData.setCh(new Double[]{lpData[0].getCh()[0], lpData[0].getCh()[1], 
