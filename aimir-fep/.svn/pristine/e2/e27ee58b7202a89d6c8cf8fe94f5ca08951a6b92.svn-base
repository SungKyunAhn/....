...
public class EV_SP_200_64_0_Action implements EV_Action {
	...
	public void execute(FMPTrap trap, EventAlertLog event) throws Exception {
		logger.debug("[EV_SP_200_64_0_Action][evtOTADownloadStart][{}] Execute.", EVENT_MESSAGE);
		...
		try {
			...
			logger.debug("[EV_SP_200_64_0_Action][evtOTADownloadStart] DCU = {}({}), EventCode = {}", trap.getMcuId(), trap.getIpAddr(), trap.getCode());
			...
			logger.debug("[EV_SP_200_64_0_Action] upgradeType={}", OTA_UPGRADE_TYPE.getItem(upgradeType).getTargetClass().name());
