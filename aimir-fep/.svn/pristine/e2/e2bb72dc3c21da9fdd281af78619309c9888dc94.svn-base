 ...
 */
public class NT025 implements java.io.Serializable {

	private static final long serialVersionUID = -2846987238640994062L;
	...
	private byte[] data;
    private static Log log = LogFactory.getLog(NT025.class);
	...
	private final static int SIZE_COINCIDENT = 0;
	 ...
	 */
	public NT025(byte[] data, int nbr_tiers, int nbr_sum, int nbr_dmd, int nbr_coin,
