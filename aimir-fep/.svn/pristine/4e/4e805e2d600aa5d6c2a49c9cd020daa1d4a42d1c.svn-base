...
*/
class StandardObisCodeCollection extends java.util.ArrayList<StandardObisCode>
{
    /*
    ...
    public final StandardObisCode find(String ln, ObjectType objectType)
    {
    ...
    */
    private boolean equalsInterface(StandardObisCode it, int ic)
    {
    ...
    */
    public final StandardObisCode find(int[] obisCode, int IC)
    {
        StandardObisCode tmp;
        for (StandardObisCode it : this)
        {
            //Interface is tested first because it's faster.
            if (equalsInterface(it, IC) && equalsObisCode(it.getOBIS(), obisCode))
            {
                tmp = new StandardObisCode(it.getOBIS(), 
        ...
        tmp = new StandardObisCode(null, "Manufacturer specific", (new Integer(IC)).toString(), "");
        String[] obis = tmp.getOBIS();
        obis[0] = Integer.toString(obisCode[0]);
        obis[1] = Integer.toString(obisCode[1]);
        obis[2] = Integer.toString(obisCode[2]);
