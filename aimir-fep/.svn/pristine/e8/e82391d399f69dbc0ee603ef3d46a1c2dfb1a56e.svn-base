/* 
 * @(#)LK1210DBR_MTR.java       1.0 07/11/08 *
 * 
 * Meter Information
 ...
 * @author Kang Soyi ksoyi@nuritelecom.com
 */
public class LK1210DRB_MTR implements java.io.Serializable{    
	 ...
	 */
	public LK1210DRB_MTR(byte[] rawData) {
