 ...
 */
@Component
public class EV_200_12_0_Action implements EV_Action
{
    private static Log log = LogFactory.getLog(EV_200_12_0_Action.class);
    ...
    {
        log.debug("EV_200_12_0_Action : EventCode[" + trap.getCode()
                +"] MCU["+trap.getMcuId()+"]");
