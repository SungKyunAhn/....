 ...
 */
public class ST071 implements java.io.Serializable {

	private static final long serialVersionUID = 3171603010462159038L;
    ...
    private static Log log = LogFactory.getLog(ST071.class);
