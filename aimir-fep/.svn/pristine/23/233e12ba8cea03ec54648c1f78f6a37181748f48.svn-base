...
public class Manufacturer
{
    ...
    private java.util.ArrayList<DLMSAuthentication> privateSettings;
    private java.util.ArrayList<ServerAddress> privateServerSettings;
    ...
    */
    public Manufacturer()
    {
        ...
        m_ObisCodes = new ObisCodeCollection();
        setSettings(new java.util.ArrayList<DLMSAuthentication>());
        setServerSettings(new java.util.ArrayList<ServerAddress>());
    ...
    */
    ...
    /** 
     Initialize settings.
    */
    public final java.util.ArrayList<DLMSAuthentication> getSettings()
    {
        return privateSettings;
    }
    public final void setSettings(java.util.ArrayList<DLMSAuthentication> value)
    {
    ...
    /** 
     Server settings
    */
    public final java.util.ArrayList<ServerAddress> getServerSettings()
    {
        return privateServerSettings;
    }
    public final void setServerSettings(java.util.ArrayList<ServerAddress> value)
    {
    ...
    {
        for (DLMSAuthentication it : getSettings())
        {
    ...
    public final ServerAddress getServer(HDLCAddressType type)
    {
        for (ServerAddress it : this.getServerSettings())
        {
