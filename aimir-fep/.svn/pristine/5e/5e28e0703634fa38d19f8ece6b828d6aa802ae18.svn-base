...
public class ReqDeviceInfo extends ReqNode{

	private MGMT_DEFINITION mgmtDefinition;
	
	public ReqDeviceInfo(MGMT_DEFINITION mgmtDefinition, String cseBase, String nodeName, String seq, HttpServletRequest request,
