...
public class DLMSIECOpticalPortSetup extends DLMSObject implements DLMSBase
{
    ...
    */
    public DLMSIECOpticalPortSetup(String ln)
    {
        this(ln, 0);
    }
    ...
    */
    public DLMSIECOpticalPortSetup(String ln, int sn)
    {
    ...
    public Object getValue(int index, int selector, Object parameters)
    {
        ...
        if (index == 6)
        {
            ...
            {
                Logger.getLogger(DLMSIECOpticalPortSetup.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public void setValue(int index, Object value)
    {
        ...
        {
            setDeviceAddress(DLMSClient.changeType((byte[])value, DataType.STRING).toString());
        }
        else if (index == 7)
        {
            setPassword1(DLMSClient.changeType((byte[])value, DataType.STRING).toString());
        }
        else if (index == 8)
        {
            setPassword2(DLMSClient.changeType((byte[])value, DataType.STRING).toString());
        }
        else if (index == 9)
        {
            setPassword5(DLMSClient.changeType((byte[])value, DataType.STRING).toString());
        }
        else
        {
            throw new IllegalArgumentException("GetValue failed. Invalid attribute index.");
