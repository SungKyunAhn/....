...
public class NiTcpStartClient{
	...
	public static void main(String[] args) {
		...
		// TODO Auto-generated method stub
    	  ...
    	  target.setIpv6Addr("fd00:0:0:100::101");
    	  target.setPort(18567);
...
//    	  target.setPort(65363);
    	  ...
    	  command.setClientBaseInfo(
    			  command.niAttributeId.UploadMeteringData
    			  ,command._commandFlow.Request
    			  ,command._commandType.Set
...
//    	  System.out.println(((ModemEventLog)command.abstractCmd).toString());
    	  ...
    	  System.out.println(((UploadMeteringData)command.abstractCmd).getStatus());
		}catch(Exception e){
			e.printStackTrace();
		}
	}
