 ...
 */
public class ST052 implements java.io.Serializable {

	private static final long serialVersionUID = 5620096733587648849L;
	public static final int OFS_TM = 0;
	public static final int LEN_TM = 6;
    
    public static final int OFS_TIME_DATE_QUAL_BFLD = 6;
