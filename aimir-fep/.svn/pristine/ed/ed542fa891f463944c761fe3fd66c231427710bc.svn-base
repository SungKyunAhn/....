...
public class DLMSGprsSetup extends DLMSObject implements DLMSBase
{
    ...
    */
    public DLMSGprsSetup()
    {
        ...
        DefaultQualityOfService = new DLMSQualityOfService();
        RequestedQualityOfService = new DLMSQualityOfService();
    }
    ...
    */
    public DLMSGprsSetup(String ln)
    {
    ...
    */
    public DLMSGprsSetup(String ln, int sn)
    {
    ...
    public Object getValue(int index, int selector, Object parameters)
    {
        ...
        if (index == 4)
        {
            ...
            {
                data.write((byte) 5);
                Common.setData(data, DataType.UINT8, DefaultQualityOfService.getPrecedence());
                Common.setData(data, DataType.UINT8, DefaultQualityOfService.getDelay());
                Common.setData(data, DataType.UINT8, DefaultQualityOfService.getReliability());
                Common.setData(data, DataType.UINT8, DefaultQualityOfService.getPeakThroughput());
                Common.setData(data, DataType.UINT8, DefaultQualityOfService.getMeanThroughput());
                data.write((byte) 5);
                Common.setData(data, DataType.UINT8, RequestedQualityOfService.getPrecedence());
                Common.setData(data, DataType.UINT8, RequestedQualityOfService.getDelay());
                Common.setData(data, DataType.UINT8, RequestedQualityOfService.getReliability());
                Common.setData(data, DataType.UINT8, RequestedQualityOfService.getPeakThroughput());
                Common.setData(data, DataType.UINT8, RequestedQualityOfService.getMeanThroughput());
    ...
    public void setValue(int index, Object value)
    {
        ...
        {            
            ...
            {            
                setAPN(DLMSClient.changeType((byte[]) value, DataType.STRING).toString());
            }
        }
        else if (index == 3)
        {            
