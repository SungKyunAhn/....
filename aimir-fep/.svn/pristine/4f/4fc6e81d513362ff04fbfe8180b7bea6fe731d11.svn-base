...
/**
 * {@link WCDMASMSClientProtocolHandler} implementation of FEP (AiMiR and Meter Protocol).
 *
 * @author Yeon Kyoung Park
 * @version $Rev: 1 $, $Date: 2008-01-05 15:59:15 +0900 $,
 */
public class WCDMASMSClientProtocolHandler extends IoHandlerAdapter
{
    private static Log log = LogFactory.getLog(WCDMASMSClientProtocolHandler.class);
