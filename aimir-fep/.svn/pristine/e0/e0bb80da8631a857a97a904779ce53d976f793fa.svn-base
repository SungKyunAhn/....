 ...
 */
public class ST061 implements java.io.Serializable {

	private static final long serialVersionUID = 5662377217309038664L;
	...
	private byte[] data;
    private static Log log = LogFactory.getLog(ST061.class);
