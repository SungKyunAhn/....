...
import com.aimir.fep.bypass.dlms.enums.AddressState;
 ...
 */
public class DLMSMBusSlavePortSetup extends DLMSObject implements DLMSBase
{
    ...
    */
    ...
    /**  
     ...
     @param ln Logican Name of the object.
    */
    public DLMSMBusSlavePortSetup(String ln)
    {
    ...
    */
    public DLMSMBusSlavePortSetup(String ln, int sn)
    {
